...
├── src/
│   ├── agents/             # CrewAI logic
│   │   ├── tools/          # Custom tools (yfinance, scraper)
│   │   ├── agents.py       # Agent personas and configurations
...
│   └── shared/             # Azure integration and config
│       ├── database.py     # Azure Postgres service
│       ├── storage.py      # Azure Blob service
